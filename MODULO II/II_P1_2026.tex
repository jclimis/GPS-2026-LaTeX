...
\paragraph{Paso 5: Puntos de CU Sin Ajuste (UUCP)}

\begin{cajaFormula}
\[ \text{UUCP} = \text{UAW} + \text{UUCW} = 5 + 30 = \mathbf{35} \]
\end{cajaFormula}
...
\paragraph{Paso 7: Factor de Entorno (ECF)}
...
\paragraph{Paso 8: PCU Ajustados (AUCP)}
...
\paragraph{Pasos 9 y 10: Estimación del Esfuerzo y Duración}
